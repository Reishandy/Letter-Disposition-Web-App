        ...
        <div class="content">
                ...
                <div class="container-fluid">
                    <div class="collapse navbar-collapse">
                        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                            <li class="nav-item">
                                <a class="nav-link active" href="#">Received letters</a>
                            </li>
            ...
            <div class="container-fluid">
                <div class="div-letters row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-4 row-cols-xl-5 row-cols-xxl-6 g-3">
                    ...
                    $stmt = $conn->prepare("SELECT * FROM letters WHERE receiver = ? ORDER BY id DESC");
                    ...
                    while ($row = $result->fetch_assoc()) {
                        ...
                        <div class="card m-2 div-letter">
                            ...
                            <div class="card-body">
                                ...
                                <a href="update_status.php?id=<?php echo $id ?>"
                                   class="btn btn-outline-dark <?php echo $status == 1 ? 'disabled' : '' ?>">Approve</a>
                            </div>
                        </div>
                        <?php
                    }
